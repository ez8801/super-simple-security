...
namespace Security
{
    ...
    {
        static Action m_onHackDetectListener;
        
        static public void SetOnHackDetectListener(Action l)
        {
            m_onHackDetectListener = l;
        }

        //
        static public void OnHackDetect(string message)
        {
            Console.WriteLine(string.Format("Security detected hack! message={0}", message));
            if (m_onHackDetectListener != null)
                m_onHackDetectListener.Invoke();
        }

        //
        static public void OnError(string message)
        {
